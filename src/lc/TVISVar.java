...
/**
 * A TVarsInScope for code that appears within the scope of a single variable (i.e., an EFrom
 * binding).
 */
class TVISVar extends TVarsInScope {

  private DefVar v;

  /** Default constructor. */
  TVISVar(TVarsInScope enclosing, DefVar v) {
    super(enclosing);
    this.v = v;
  }
